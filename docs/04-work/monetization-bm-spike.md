...
> **2026-09-19 결정 철회.** 이 문서의 권고안(A: 광고 제거 IAP)은 **추진하지 않는다.**
> 스토어에 상품을 등록하지 않은 채 "광고 제거" 구매 동선만 앱에 들어가 App Store 심사에서
> Guideline 2.1(b)로 반려됐고, 확인 결과 App Store·Google Play 어느 쪽에도 등록된 상품이
> 없어 구매 자체가 불가능한 상태였다. 관련 코드는 전부 제거했고 인앱 결제 계획은 없다.
> 아래 내용은 당시 검토 기록으로만 남긴다.
