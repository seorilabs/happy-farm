...
// 광고 미지원/무필 환경(AppsInToss 무광고·mobile_ads kill switch 등)에서 watch_ad 미션은
// 영구 미완이 되어 일일 100% 완주와 그 보상을 봉쇄한다(#366). 광고가 지원되지 않으면 표시·
// 수령 목록에서 watch_ad 슬롯을 제외해 완주 가능성을 보장한다. 진행도 기록 경로
