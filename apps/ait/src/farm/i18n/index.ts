...
const KO_FARM_MESSAGES = {
  ...
  sheetTitleAreaUnlocked: '🎉 새 구역 해금!',
  sheetDescriptionAreaUnlocked: (areaName: string) => `${areaName}에서 새 작물을 심을 수 있어요.`,
  areaUnlockedNewCropsLabel: '새로 심을 수 있는 작물',
  areaUnlockedCta: '이 구역 둘러보기',
...
const EN_FARM_MESSAGES: FarmMessages = {
  ...
  sheetTitleAreaUnlocked: '🎉 New Area Unlocked!',
  sheetDescriptionAreaUnlocked: (areaName) => `You can now plant new crops in ${areaName}.`,
  areaUnlockedNewCropsLabel: 'New crops available',
  areaUnlockedCta: 'Explore this area',
