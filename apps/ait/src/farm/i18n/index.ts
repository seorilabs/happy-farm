...
const KO_FARM_MESSAGES = {
  ...
  comboGreatToast: '🔥 GREAT 콤보! +10% 골드 보너스 활성화',
  comboLegendaryToast: '⚡ LEGENDARY 콤보! +25% 골드 보너스 활성화',
...
const EN_FARM_MESSAGES: FarmMessages = {
  ...
  comboGreatToast: '🔥 GREAT Combo! +10% gold bonus active',
  comboLegendaryToast: '⚡ LEGENDARY Combo! +25% gold bonus active',
